...
public class QkartSanity {
    ...
    private static final String StartTestCase = null;
    private static final String TestCase01 = null;
    ...
    public static void takeScreenshot(WebDriver driver, String screenshotType, String description) {
         ...
         */
         ...
         try{
            ...
            String fileName=String.format("screenshot_%s_%s_%s_.png",timeStamp,screenshotType,description);
    ...
    public static Boolean TestCase06(RemoteWebDriver driver) throws InterruptedException {
        ...
        if (!status) {
            logStatus("Test Step", "User Perform Login: ", status ? "PASS" : "FAIL");
            logStatus("End TestCase", "Test Case 5: Verify user Registration : ", status ? "PASS" : "FAIL");
            //return false;
            takeScreenshot(driver, "FAILED", "TestCase06");
        }
...
homePage.addProductToCart("Xtend Smart Watch");
    ...
    public static Boolean TestCase08(RemoteWebDriver driver) throws InterruptedException {
        ...
        logStatus("Step", "Verify cart contents Failed", status ? "PASS" : "FAIL");
        driver.close();
    ...
    public static Boolean TestCase09(RemoteWebDriver driver) throws InterruptedException {
        ...
        logStatus("Start TestCase","Test Case 9: Verify Privacy Policy and Terms of Serviceo","DONE");
        Home homePage = new Home(driver);
        homePage.navigateToHome();
        WebElement privacyPolicy=driver.findElement(By.xpath("//a[text()='Privacy policy']"));
        privacyPolicy.click();
        ...
        if(currentUrl.equals("https://crio-qkart-frontend-qa.vercel.app/")){
            logStatus("Step","Verify Privacy Policy and Terms of Serviceo","PASS");
            status=true;
    }else{
        logStatus("Step","Verify Privacy Policy and Terms of Serviceo","FAIL");
        return false;
    }
        ...
        if(currentUrl2.equals("https://crio-qkart-frontend-qa.vercel.app/")){
            logStatus("Step","Verify Privacy Policy and Terms of Serviceo","PASS");
            status=true;
    }else{
        logStatus("Step","Verify Privacy Policy and Terms of Serviceo","FAIL");
    ...
    WebElement termsOfServiceHeading=driver.findElement(By.xpath("//h2[text()='Terms of Service']"));
        ...
        logStatus("Step","Verify Privacy Policy and Terms of Service","PASS");
        driver.close();
        driver.switchTo().window(windows[1]);
        driver.close();
        driver.switchTo().window(windows[0]);
    ...
    public static Boolean TestCase10(RemoteWebDriver driver) throws InterruptedException {
        ...
        WebElement contactNowElement=driver.findElement(By.xpath("//button[text()=' Contact Now']"));
        contactNowElement.click();


        WebDriverWait wait=new WebDriverWait(driver,3);
        status=wait.until(ExpectedConditions.invisibilityOfElementLocated(By.xpath("//button[text()=' Contact Now']")));
        logStatus("End TestCase","Test Case 10: Verify 'Contact Us' link works fine: ", status ? "PASS" : "FAIL");
